			  ...
			  TweenMax.to( $('#i'), 0.8 , {rotationX : 0, onComplete: function() {
			      $('#i').css('transform', '');
					      ...
					      if (iVal < 10) {
								...
								var newStep2 = {
										element : "#sop",
										intro : "This statement prints the value of <b class='ct-code-b-yellow'>i</b>.",
										position : "bottom"
								}
...
function introJsGuide() {
	...
	introjs.setOptions({
		steps : [ {
			...
			intro : "The local variable <b class='ct-code-b-yellow'>i</b> initialized to " 
...
int main() {
	int i;
	<span id='brkLoop'>for (<span id='initialization' class="position-relative">i = <span id="initializationValue" class="allowNumbers position-relative" maxlength="1" contenteditable=false placeholder=" ">1</span>;</span> <span id='condition'>i < 10;</span> <span id='update'>i++</span>) {
