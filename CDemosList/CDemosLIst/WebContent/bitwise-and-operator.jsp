		...
		intro.onafterchange(function(targetElement) {
			...
			case "informationDiv":
				...
				var text = "<br><ul><li>Bitwise operators are used for manipulation of data at bit level (binary data).</li>" 
					+ "<li>The bitwise AND operator is represented as a single <span class='ct-code-b-green'>ampersand: &</span></li>"
					+ "<li>Bitwise AND(&) operator is performed on only binary data.</li>" 
					+ "<li>The output of bitwise AND is 1 if the corresponding bits of all operands is 1. If either bit of an operand" 
					+ " is 0, the result of corresponding bit is evaluated to 0.</li>" 
					+ "</ul>";
			...
			case "inputDiv":
				...
				$(".introjs-helperLayer ").one('transitionend', function() {
					...
					TweenMax.to("#secondNum", 1, {"opacity" : "1", onComplete:function() {
						var text = "Enter two values to perform <span class='ct-code-b-yellow'>Bitwise AND (&)</span> operation between them.";
			...
			case "table1":
				...
				$(".introjs-helperLayer ").one('transitionend', function() {
					$("#table1").removeClass("opacity00").hide().fadeIn(2000, function() {
						var text="As per the table the Bitwise AND(&) Operation will return <span class = 'ct-code-b-yellow'>1</span> only" 
									+ " when <span class = 'ct-code-b-yellow'>both</span> the bits of A and B are <span class = 'ct-code-b-yellow'>1's</span>.<br>" 
						...
						$("#value").effect("highlight", {color: '#FF0000'}, 1000, function() {
							...
							setTimeout(function(){
								$("#value2").effect("highlight", {color: '#FF0000'}, 1000, function() {
									...
									var text = "Here to understand easily about the Bitwise AND (&) operation we have a table.";
									typing(".introjs-tooltiptext", text, function() {
