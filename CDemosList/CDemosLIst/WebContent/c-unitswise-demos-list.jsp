			...
			<table class='table table-bordered'>
				...
				<tbody class='table-striped'>
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('History of C Language', 'c-language-timeline.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; History of C Language</td>
						<td>Ajay</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('C program life cycle', 'c-program-life-cycle.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; C program life cycle</td>
						<td>Mallika</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>25-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('C Identifiers', 'c-identifiers.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; C Identifiers</td>
						<td>Mahesh</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Coding Conventions in a C program', ' ', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Coding Conventions in a C program</td>
						<td>Pavan</td>
						<td></td>
						<td></td>
						<td>03-10-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Statements in C language', 'statements-in-C.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Statements in C language</td>
						<td>Padmaja</td>
						<td>Sekhar -- suceess</td>
						<td>Successfully completed </td>
						<td>21-09-2016</td>
						...
						<td>
							...
							<div>
								<a class='btn btn-xs btn-success'
									...
									class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; explanation of	#include
							</div>
					...
					<tr>
						<td>7</td>
						<td>Sample program in C using printf(), scanf()</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Sample program in C', '', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Sample program in C</td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Binary to Decimal', 'binary-to-decimal-convertion.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Binary to Decimal</td>
						<td>Suresh</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>20-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Binary to Octal', 'binary-to-octal.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Binary to Octal conversion</td>
						<td>Shiva</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>20-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Binary to Hexadecimal', 'binary-to-hexa.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Binary to Hexadecimal conversion</td>
						<td>Shiva</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>25-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Decimal to Binary', 'decimal-to-binary.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Decimal to Binary</td>
						<td>Live-Demo</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Decimal to Octal', 'decimal-to-octal.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Decimal to Octal</td>
						<td>Live-Demo</td>
						<td>Ramana -- success</td>
						<td>Successfully Completed</td>
						<td>same as JAVA</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Decimal to Hexadecimal', 'decimal-to-hexadecimal.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Decimal to	Hexadecimal</td>
						<td>Live-Demo</td>
						<td>Ramana -- success</td>
						<td>Successfully Completed</td>
						<td>same as JAVA</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Octal to Binary', 'octal-to-binary-conversion.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Octal to Binary</td>
						<td>Suresh</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>23-09-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Octao to Decimal', 'octal-to-decimal-conversion.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Octal to Decimal</td>
						<td>Suresh</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>28-09-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Octal to Hexadecimal', 'octal-to-hexadecimal-conversion.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Octal to Hexadecimal</td>
						<td>Suresh</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>30-09-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Hexadecimal to Binary', 'hexadecimal-binary.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Hexadecimal to Binary</td>
						<td>Padmaja</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>28-09-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Hexadecimal to Decimal', 'hexadecimal-decimal.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Hexadecimal to Decimal</td>
						<td></td>
						<td></td>
						<td></td>
						<td>29-09-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Hexadecimal to Octal', 'hexadecimal-octal.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Hexadecimal to Octal</td>
						<td></td>
						<td></td>
						<td></td>
						<td>01-10-2016</td>
					...
					<tr>
						...
						<td>int datatype</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('int Data-type', 'intdatatype.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; int Data-type</td>
						<td>Padmaja</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>20-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('short int Data-type', 'short-datatype.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; short int Data-type</td>
						<td>Padmaja</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>22-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('long int Data-type', 'long-data-type.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; long int Data-type</td>
						<td>Padmaja</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>24-08-2016</td>
					...
					<tr>
						...
						<td>char datatype</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('char Data-type', 'char-in-c.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; char Data-type</td>
						<td>Padmaja</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>04-09-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Different Data-types in C', 'datatypes-in-c.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Different Data-types in C</td>
						<td>Padmaja</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>20-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Constants in C', 'constants-in-C.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Constants in C</td>
						<td>Padmaja</td>
						<td></td>
						<td></td>
						<td>25-09-2016</td>
					...
					<tr>
						<td>28</td>
						<td>How a C program works</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('How a C language works', 'how-c-language-works.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; How a C language works</td>
						<td>Ramya</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>12-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of ones complement', 'ones-complement.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; explanation of	one's complement</td>
						<td>Ramya</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>16-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of twos complement', 'twos-complement.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; explanation of two's complement</td>
						<td>Ramya</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>18-08-2016</td>
			...
			<table class='table table-bordered'>
				...
				<tbody class='table-striped'>
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Execution of Arithmetic Operators', 'arithmetic-operators.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Execution of Arithmetic Operators</td>
						<td>Karthik</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>29-09-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Execution of Relational Operators', 'relational-operators.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Execution of Relational Operators</td>
						<td>Karthik</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>01-09-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Execution of Logical Operators', 'logical-operators.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Execution of Logical Operators</td>
						<td>Karthik</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>03-09-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Execution of Assignment Operator', 'assignment-operators.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Execution of Assignment Operator</td>
						<td>Karthik</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>07-09-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Conditional Operators', 'conditional-operator.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Conditional Operators</td>
						<td>Pavan</td>
						<td></td>
						<td></td>
						<td>17-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Execution of Bitwise AND Operator', 'bitwise-and-operator.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Execution of Bitwise AND Operator</td>
						<td>Ramya</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>17-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Execution of Bitwise OR Operator', 'bitwise-or-operator.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Execution of Bitwise OR Operator
						</td>
						<td>Ramya</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Execution of Bitwise XOR Operator', 'bitwise-xor-operator.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Execution of Bitwise XOR
							Operator</td>
						<td>Ramya</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Execution of Bitwise LeftShif', '', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Execution of Bitwise LeftShif</td>
						<td>Ramya</td>
						<td></td>
						<td></td>
						<td>23-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Execution of Bitwise RightShift', '', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Execution of Bitwise RightShift</td>
						<td>Ramya</td>
						<td></td>
						<td></td>
						<td>25-08-2016</td>
					...
					<tr>
						...
						<td>Bitwise Operators</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Execution of Bitwise NOT', 'bitwise-not-operator.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Execution of Bitwise NOT</td>
						<td>Ramya</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>27-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Special Operators', 'special-operators.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Special Operators</td>
						<td>Pavan</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>20-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Type Conversion', 'type-conversion.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explicit Type Conversion', 'explicit-type-conversion.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Explanation of Explicit Type Conversion</td>
						<td>Suresh</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>26-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Operator Precedence and Associativity', 'operator-precedence-associativity.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Operator Precedence and Associativity</td>
						<td>Anil</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>29-08-2016</td>
			...
			<table class='table table-bordered'>
				...
				<tbody class='table-striped'>
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of #include', 'include.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Explanation of #include</td>
						<td>Anil</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>01-09-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of #if #else', 'usage-of-if-else.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of #if #elif', '', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of #undef', '', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of getchar()', 'usage-of-getchar.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Usage of getchar()</td>
						<td>Shiva</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>22-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of putchar()', 'usage-of-putchar.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Usage of putchar()</td>
						<td>Shiva</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>24-08-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Usage of gets() & puts()', 'gets-puts-on-strings.jsp', 1, 1)"><i
						...
						<td>
							<div>
								<a class='btn btn-xs btn-success'
									...
									class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; printf() with blank space
							</div>
							...
							<div>
								<a class='btn btn-xs btn-success'
									href="javascript:opendialog('Features of printf()', 'printf-with-fieldwidth.jsp', 1, 1)"><i
							...
							<div>
								<a class='btn btn-xs btn-success'
									href="javascript:opendialog('Features of printf()', 'printf-with-zeros.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Basic Structure of C', 'structure-of-c.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Basic Structure of C Program</td>
						<td>Anil</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
						<td>10-09-2016</td>
					...
					<tr>
						...
						<td>
							...
							<div>
								<a class='btn btn-xs btn-success'
									href="javascript:opendialog('Program to Read and Print a character', 'program-to-print-character.jsp', 1, 1)"><i
									class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Program to Read and Print a character
							</div>
							<div>
								<a class='btn btn-xs btn-success'
									href="javascript:opendialog('Conversion of Upper to Lower case', 'upper-to-lowercase-program.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Swap of 2 numbers', 'swap-with-temp-variable.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Swap of 2 numbers</td>
						<td>Manikanta</td>
						<td></td>
						<td></td>
						<td>27-09-2016</td>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Swap of 2 two numbers without temporary', 'swap-without-temp-variable.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Swap of 2 two numbers without temporary variable</td>
						<td>Manikanta</td>
						<td></td>
						<td></td>
						<td>28-09-2016</td>
			...
			<table class='table table-bordered'>
				...
				<tbody class='table-striped'>
					<tr>
						...
						<td>if-else</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of if-else', 'if-else-c.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Explanation of if-else</td>
						<td>Padmaja</td>
						<td>Sekhar -- success</td>
						<td>Successfully Completed</td>
					...
					<tr>
						...
						<td>if-else-if</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Execution of if-else-if', '', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Execution of Nested if-else-if', '', 1, 1)"><i
					...
					<tr>
						<td>5</td>
						<td>if-else-if ladder</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Execution of if-else-if ladder', '', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Execution of if-else-if ladder</td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
					...
					<tr>
						...
						<td>Switch case</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of switch-case', 'switch-in-c.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td>While loop</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of while loop', 'whileloop-in-c.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td>do-while</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of do-while loop', 'doWhile-in-c.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td>for loop</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of for loop', 'forloop-in-c.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Explanation of goto Statement', 'goto-statement.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Program to print pyramind', '', 1, 1)"><i
					...
					<tr>
						<td>15</td>
						<td>Program to print Pascal triangle</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Program to print Pascal triangle', '', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Program to print Pascal triangle</td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
			...
			<table class='table table-bordered'>
				...
				<tbody class='table-striped'>
					...
					<tr>
						...
						<td>2-D Arrays</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Accessing Two-dimensional arrays', '', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Bubble sort', 'bubble-sort.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td>Sorting Technique</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Insertion sort', 'insertion-sort-java.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td>Sorting Technique</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Selection sort with largest element', '', 1, 1)"><i
					...
					<tr>
						...
						<td>Sorting Technique</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Selection sort with smallest element', 'selection-sort-smallest-element-java.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Linear search', '', 1, 1)"><i
					...
					<tr>
						...
						<td>Searching Technique</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Binary search', '', 1, 1)"><i
					...
					<tr>
						...
						<td>Program on arrays</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Program to Interchange two rows in a matrix', '', 1, 1)"><i
			...
			<table class='table table-bordered'>
				...
				<tbody class='table-striped'>
					<tr>
						...
						<td>Strings</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Read and Write Strings using scanf() and printf()', 'scanf-printf-on-strings.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td>Strings</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Read and Write Strings using getChar() & putChar() ', 'getchar-for-reading-strings.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td>Strings</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Read and Write Strings using gets() & puts()', 'gets-puts-on-strings.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Different String functions', '', 1, 1)"><i
			...
			<table class='table table-bordered'>
				...
				<tbody class='table-striped'>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Program Life Cycle Demo', 'sample-progaram-sinx-cosx.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Function with arrays', 'functions-with-arrays.jsp', 1, 1)"><i
								class='fa fa-eye'></i>&nbsp;Live Demo</a> &emsp; Function with arrays (sort or search program)</td>
						<td>Ajay</td>
						<td></td>
						<td></td>
						<td>03-10-2016</td>
					...
					<tr>
						...
						<td>Program on Functions</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Sample program on functions', 'functions.jsp', 1, 1)"><i
			...
			<table class='table table-bordered'>
				...
				<tbody class='table-striped'>
					...
					<tr>
						...
						<td>Storage Classes</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Extern Variables', '', 1, 1)"><i
					...
					<tr>
						...
						<td>Storage Classes</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Register Variables', '', 1, 1)"><i
			...
			<table class='table table-bordered'>
				...
				<tbody class='table-striped'>
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Program to find Factorial of a number using Recursion', '', 1, 1)"><i
					...
					<tr>
						...
						<td>Program on Recursion</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Towers of Hanoi problem', '', 1, 1)"><i
					...
					<tr>
						...
						<td>Program on Recursion</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Program to print Fibonacci series using Recursion', '', 1, 1)"><i
			...
			<table class='table table-bordered'>
				...
				<tbody class='table-striped'>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Pointers declaration', '', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Pointers with 1-D arrays', '', 1, 1)"><i
					...
					<tr>
						...
						<td>Pointers with Arrays</td>
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Pointers with 2-D arrays', '', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Arrays of Pointers', '', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Pointer to an array', '', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Multiple indirection operator', '', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Disadvantages in Pointers', '', 1, 1)"><i
			...
			<table class='table table-bordered'>
				...
				<tbody class='table-striped'>
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Processing of a Structure using dot operator', 'processing-of-structure.jsp', 1, 1)"><i
					...
					<tr>
						...
						<td><a class='btn btn-xs btn-success'
							href="javascript:opendialog('Structure vs Union', '', 1, 1)"><i
