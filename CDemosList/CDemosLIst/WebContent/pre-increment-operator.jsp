		...
		var elementId = targetElement.id;
			switch (elementId) {
				case "program" :
					...
					text = 'Here we will learn how the <span class="ct-code-b-yellow">pre-increment</span>'+
				...
				case "yVariableDeclararionLine"  :
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						case "working" :
							$('.introjs-tooltip').removeClass('hide');
							text = 'First let us know how the <span class="ct-code-b-yellow">pre-increment operator</span> '+
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						TweenMax.to('.animation-div1', 1, {opacity: 1, onComplete: function() {
							svgBoxAnimation(0, function(){
								$('.introjs-tooltip').removeClass('hide');
								text = 'When it is used in an expression, the <span class="ct-code-b-yellow">pre-increment</span> '+
										' operator first the value of <span class="ct-code-b-yellow">x</span> will be increment by '+
				...
				case "singleStatement"  :
					...
					$('.introjs-helperLayer').one('transitionend', function() {
							$('.introjs-tooltip').removeClass('hide');
							text = 'Let us see how <span class="ct-code-b-yellow">pre-increment operator</span> works on a single statement.';
							typing('.introjs-tooltiptext', text, typingInterval, 'white', function(){
								$('.introjs-nextbutton').show();
							});
					});
