...
$(document).ready(function() {
	...
	intro.onafterchange(function(targetElement) {
		...
		case "animationDiv":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "<span id='first'>Here we see the different logical operator with expressions.</span><ul><span id='amperson'></span></ul>";
				typing(".introjs-tooltiptext", text, function() {
	...
	$("#informationDiv").removeClass("visibility-hidden");
	 var text = "<ul><li>In addition to the <span class='ct-code-b-green'>relational and equality operators</span>, C contains two binary <span class='ct-code-b-green'>logical"
		+" operators</span> and one <span class='ct-code-b-green'>unary logical operator</span>. They are listed below.</li>"
		...
		+" requires only one operand which represents a logical value <span class='ct-code-b-green'>0</span> or <span class='ct-code-b-green'>non-zero</span>.</li><li>The result of"
...
var next = 0;
	...
	$(".next-button").click(function() {
		 ...
		 if (next == 0) {
			...
			setTimeout(function() {
			var text = "<li>For logical <span class='ct-code-b-yellow'>AND</span> operator. If both the operands"
			...
			flipEffect($("table tr:eq(1) td:eq(0) span:eq(1)"),parseInt(firstVal), function() {
			 ...
			 $(".next-button").addClass("visibility-hidden");
				...
				setTimeout(function() {
					var text = "<li>For logical <span class='ct-code-b-yellow'>OR</span> operator. If any of the two"
							+" operands or expression is non-zero, then the condition becomes <span class='ct-code-b-yellow'>true</span>"
							+" else return <span class='ct-code-b-yellow'>false</span>.</li><span id='lNOT'></span>"
			...
			setTimeout(function() {
				var text = "<li>For logical <span  class='ct-code-b-yellow'>NOT</span> operator. It is used to reverse the logical state of its operand."
