...
function introGuide() {
	...
	introjs.onafterchange(function(targetElement) {
		...
		case "description":
			...
			var text = "<ul><li>In scanf ( ), the control string is scanned from left to right. In addition to conversion specifications, "+
						"it may contain other characters.</li><li>If the character matches, that character is read from the input data and ignored.</li>"+
						"<li>This facilitates the user to enter the inputs in any convenient form.</li></ul>.";
			typing("#desText", text, function() {
				var text2 = "Let us see how it works by entering the first input preceded by Rs. and other input followed by %";
		...
		case "varDeclaratn":
			$(".introjs-nextbutton").hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Here we are declaring two integer variables <b>ammount</b> and <b>interest</b>.";
				typing(".introjs-tooltiptext", text, function() {
					$(".introjs-nextbutton").show();
				});
			});
		...
		case "addressDiv":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				...
				if (introjs._currentStep == 3) {
					...
					var text = "This is the location of given two integer variables ammount and interest allocated at respected " 
					...
					$("#rsBlink").addClass("blinking-white");
					$("#rsBlink").addClass("zIndex");
					
					$("#dBlink1").delay(1000).queue(function() {
						$("#rsBlink").removeClass("blinking-white");
						$("#rsBlink").removeClass("zIndex");
						var txt1 = "Here characters <span class='ct-code-b-yellow'>Rs.</span> are not assigned to the arguments." 
								...
								tl.to("#givenNum1", 1, {opacity: 1, top:0, left:0, onComplete: function() {
									...
									$("#scanNum2").delay(1000).queue(function() {
										...
										tl.to("#givenNum2", 1, {opacity: 1, top:0, left:0, onComplete: function() {
											...
											var txt2 = "Now given values are stored in <b>ammount</b> and <b>interest</b>. <span id='appendTxt2'></span>";
											typing("#appendTxt1", txt2, function() {
												$("#extraPercnt").addClass("blinking-white");
												$("#extraPercnt").addClass("zIndex");
												$("#extraPercnt").delay(1000).queue(function() {
													$("#extraPercnt").removeClass("blinking-white");
													$("#extraPercnt").removeClass("zIndex");
													var txt3 = "Here the character <span class='ct-code-b-yellow'>%</span> is not assigned to the arguments.";
													typing("#appendTxt2", txt3, function() {
														$(".introjs-nextbutton").show();
													});
												});
											});
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				if (introjs._currentStep == 5) {
					...
					typing("#inputVal", text, function() {
						var text2 = "Enter <b>ammount</b> and <b>interest</b>"; 
		...
		case "finalPrintf":
			...
			$(".introjs-nextbutton").hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Now here we are printing <b>ammount</b> and <b>interest</b>.";
				typing(".introjs-tooltiptext", text, function() {
					$(".introjs-nextbutton").show();
				});
			});
...
<div class=" margin-top-20 col-xs-12">
  <div class="col-xs-5 center  box-border" id="description" style="height: 118px; float: unset;">
...
<div class="main-div col-xs-12" id="mainDiv">
	...
	<span id="scanf">scanf("<span id='percentile'><span id='rsBlink'>Rs.</span><span id='dBlink1'>%d</span><span id='dBlink2'>%d</span><span id='extraPercnt'>%</span></span>", <span id='scanNum1'>&ammount</span>, <span id='scanNum2'>&interest</span>);</span>
	<span id="finalPrintf">printf("ammount = %d interest = %d", ammount , interest);</span>
	</pre>
	</div>
