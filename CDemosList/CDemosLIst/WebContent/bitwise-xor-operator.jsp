		...
		intro.onafterchange(function(targetElement) {
			...
			case "informationDiv":
				...
				var text = "<br><ul><li>Bitwise operators are used for manipulation of data at bit level (binary data).</li>" 
							+ "<li>XOR also called as <span class='ct-code-b-green'>exclusive OR</span>.The bitwise XOR operator is represented as " 
							+ "<span class='ct-code-b-green'>^</span>."
							+ "<li>Bitwise XOR(^) operator is performed on only binary Data.</li>" 
							+ "<li>The output of bitwise XOR is 0 only when both the values are either 0's or 1's." 
							+ " Otherwise it is 1.</li>" 
							+ "</ul>";
			...
			case "inputDiv":
				...
				$(".introjs-helperLayer ").one('transitionend', function() {
					...
					TweenMax.to("#secondNum", 1, {"opacity" : "1", onComplete:function() {
						var text = "Enter two values to perform <span class='ct-code-b-yellow'>Bitwise XOR (^)</span> operation between them.";
			...
			case "table1":
				...
				$(".introjs-helperLayer ").one('transitionend', function() {
					$("#table1").removeClass("opacity00").hide().fadeIn(2000, function() {
						var text="As per the table the Bitwise XOR(^) Operation will return <span class = 'ct-code-b-yellow'>0</span> only" 
									+ " when <span class = 'ct-code-b-yellow'>both</span> the bits of A and B are either" 
									+ " <span class = 'ct-code-b-yellow'>0's</span> or <span class = 'ct-code-b-yellow'>1's</span>.<br>" 
				...
				$(".introjs-helperLayer ").one('transitionend', function() {
					...
					typing(".introjs-tooltiptext", text, function() {
						$("#value").effect("highlight", {color: '#FF0000'}, 1000, function() {
							$('#animationDiv').append('<div class="col-xs-8"><div class="col-xs-offset-3 col-xs-5" style="margin-top:60px;"><b>A</b> =   '
									 + '</span>' + res  + '</div></div>');
							setTimeout(function(){
								$("#value2").effect("highlight", {color: '#FF0000'}, 1000, function() {
									$('#animationDiv').append('<div class="col-xs-8"><div class="col-xs-offset-3 col-xs-5" style="margin-top:10px;"><b>B</b> =   '
											 + '</span>' + res1  + '</div></div>');
									$('#animationDiv').append('<div class="col-xs-offset-2 col-xs-2 " style="margin-top:10px;padding:0;width:22%;">'
										...
										+ '<div class="opacity00" style="margin-top:10px;" id="resultDiv"><span style="margin-left:-10px;"><b>A ^ B</b> =</span>'
									...
									var text = "Here to understand easily about the Bitwise XOR (^) operation we have a table.";
									typing(".introjs-tooltiptext", text, function() {
