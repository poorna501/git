...
$(document).ready(function() {
	...
	intro.onafterchange(function(targetElement) {
		...
		case "heading":
		    ...
		    $(".introjs-nextbutton").hide();
        	var text = "In this live demo you are going to learn how <b class ='ct-code-b-yellow'>Selection sort</b> works";
...
function firstForExe() {
	 ...
	 $(".introjs-tooltiptext ul").append("<li></li>");
	 	if(step == 0) {
			var text = "Declare a int varable<b class ='ct-code-b-yellow'> i </b> for index of an array and initialize" 
						+ "to<b class ='ct-code-b-yellow'> i = <span id ='iVal'class='ct-code-b-yellow'>" + step + "</span></b>";
	 	} else {
	 		var text = "step = " + step;
	 	}
...
function iCndtnStep() {
	$(".user-btn").remove();
	$(".introjs-tooltiptext #ulTag").append("<li class='opacity00' id = 'forCondition"+itr+"'><span class='ct-code-b-yellow display-inline-block' id='iVar"+itr+"'>i</span>"+
			" < <b><span id = 'iCheck' class='ct-code-b-yellow display-inline-block'><span id='nVar"+itr+"' class='display-inline-block ct-code-b-yellow'>n"
			+"</span><span> - 1</b></span></li>");
	...
	$("#iCond").effect("highlight", {color: 'yellow'}, 1000, function() {
		tl.to("#forCondition" + itr, 1, {opacity: 1, top:0, left:0, onComplete: function() {
			...
			flipEffect("#iVar" + itr, itr, function() {
				flipEffect("#nVar" + itr, 8, function() {
					flipEffect("#iCheck", 7, function() {
						if (duplicateArr) {
...
function forloopAnimate() {
	$("#indexDeclrtn").effect("highlight", {color: 'yellow'}, 1000, function() {
		$(".introjs-tooltiptext #ulTag").append("<li class='opacity00' id = 'tooltipIndex"+itr+"'> "+
				"<span class='ct-code-b-yellow'>int index = <span id = 'iInIndex"+itr+"' class='ct-code-b-yellow display-inline-block'>i</span></span> </li>");
				...
				tl.to('#posVal', 1, {opacity:1, top:"30px",left:"-3px",onComplete: function() {
					...
					$('#posVal').removeClass("opacity00 nValue");
						...
						$("#jDcrl").effect("highlight", {color: 'yellow'}, 1000, function() {
							$(".introjs-tooltiptext #ulTag").append("<li class='opacity00' id = 'tooltipJDcrl"+itr+"'> "+
									"<span class='ct-code-b-yellow'>int j = <span class='display-inline-block ct-code-b-yellow' id='jFlip"+itr+"'><span class='display-inline-block ct-code-b-yellow' id='iFlipJ"+itr+"'>i</span> + 1</span></span>");
							var l3 = $("#jDcrl").offset();
							...
							tl.to("#tooltipJDcrl" + itr, 1, {opacity: 1, top:0, left:0, onComplete: function() {
								...
								flipEffect("#iFlipJ" + itr, $("#tmpVal").text(), function() {
									flipEffect("#jFlip" + itr, parseInt($("#tmpVal").text()) + 1, function() {
										var cupLen2 = $("#jFlip" + itr).offset();
										$("#jVal").offset({"top": cupLen2.top, "left": cupLen2.left}).text($("#jFlip" + itr).text());
										$("#mainAnimation").removeClass('introjs-showElement');
...
function jCndtnStep() {
	...
	$(".introjs-tooltiptext #ulTag").append("<li class='opacity00' id='tooltipJCndtn'> "
			+ "<span class='ct-code-b-yellow display-inline-block' id='tooltipJ'>j</span> <span class='display-inline-block'><</span> <span class='display-inline-block ct-code-b-yellow' " 
			+ " id='tooltipJCndtnN'> n </span></li>");
	...
	$("#jCond").effect("highlight", {color: 'yellow'}, 1000, function() {
		...
		tl.to("#tooltipJCndtn", 1, {opacity: 1, top:0, left:0, onComplete: function() {
			...
			flipEffect("#tooltipJCndtnN", $("#nVal").text(), function() {
				flipEffect("#tooltipJ", $("#jVal").text(), function() {
					var text = "";
					if (parseInt($("#jVal").text()) < parseInt($("#nVal").text())) {
						text = "Evaluates to <span class='ct-code-b-yellow'>true</span>...."
					} else {
						text = "Evaluates to <span class='ct-code-b-red'>false</span>...."
					}
					$("#tooltipJCndtn").append("&emsp;<span class='display-inline-block'></span>");
...
function ifCndtnStep() {
	$(".introjs-tooltiptext #ulTag *").removeAttr("id");
	$(".introjs-tooltiptext #ulTag").append("<li class='opacity00' id='tooltipIfCndtn'> " 
			+ "<span id='tooltipArrJ' class='ct-code-b-yellow display-inline-block'>arr[" 
			+ "<span id='tooltipArrJVal' class='ct-code-b-yellow display-inline-block'>j</span>]</span>" 
			+ " <span class='display-inline-block'>&lt;</span> " 
			+ "<span id='tooltipArrIdx' class='ct-code-b-yellow display-inline-block'>arr[" 
			+ "<span id='tooltipArrIdxVal' class='ct-code-b-yellow display-inline-block'>index</span>]</span>"
			+ "</li>");
						...
						flipEffect("#tooltipArrJVal", $("#jVal").text(), function() {
							$("#arr" + $("#jVal").text()).parent().effect("highlight", {color: 'yellow'}, 1000, function() {
								flipEffect("#tooltipArrJ", $("#arr" + $("#jVal").text()).text(), function() {
									...
									$("#tooltipIfCndtn").append("&emsp;<span class='display-inline-block'></span>")
...
function smallestIndexStep() {
	...
	$(".introjs-tooltiptext #ulTag").append("<li><b id='tooltipIndex' class='ct-code-b-yellow opacity00'>"
...
function jIncrmtStep() {
	$(".introjs-tooltiptext #ulTag *").removeAttr("id");
	$(".introjs-tooltiptext #ulTag").append("<li id='tooltipJIncrmt'> " 
			+ "<span id='tooltipJ' class='ct-code-b-yellow display-inline-block opacity00'>j++</span>" 
			+ "</li>");
	...
	tl.to("#tooltipJ", 1, {opacity: 1, top:0, left:0, onComplete: function() {
		...
		flipEffect("#tooltipJ", parseInt($("#jVal").text()) + 1, function() {
			 ...
			 swapEffect("#tooltipJ", "#jVal", function() {
				 $('#tooltipJ').addClass('ct-code-b-yellow');
				jCndtnStep();
			}); 
		})
	}});
...
function smallerValStep() {
	...
	$(".introjs-tooltiptext #ulTag").append("<li><b class='opacity00 ct-code-b-yellow' id='tooltipSmaller'> " 
			+ "<span class='display-inline-block'>int smallerNumber</span>"
			+ " <span class='display-inline-block'>=</span> "
			+ "<span id='tooltipArr' class='display-inline-block'>arr[" 
			+ "<span id='tooltipArrIdx' class='display-inline-block'>index</span>]</span>"
			+ "</b></li>");
	
	
	var l2 = $("#smallerNumDclr").offset();
	$("#tooltipSmaller").offset({"top": l2.top, "left": l2.left});
	$("#mainAnimation").css("z-index", "9999999");
	tl.to("#tooltipSmaller", 1, {opacity: 1, top:0, left:0, onComplete: function() {
		$("#mainAnimation").css("z-index", "10000001");
				...
				flipEffect("#tooltipArr", $("#arr" + $("#posVal").text()).text(), function() {
					...
					if ($("#smallerNumCupDiv").hasClass("zoomIn")) {
						...
						$("#smallerNumCupDiv").removeClass("opacity00").addClass("animated zoomIn").one("animationend", function() {
							...
							$("#smallerVal").removeClass("opacity00").offset({
								"top" : l.top,
								"left" : l.left
...
function copyBiggerToSmaller() {
	...
	$(".introjs-tooltiptext #ulTag").append("<li><b class='opacity00 ct-code-b-yellow' id='tooltipCopyArrItoArrIdx'> " 
			+ "<span class='display-inline-block'>arr[" 
			+ "<span class='display-inline-block' id='tooltipIdx'>index</span>]</span>"
			+ " <span class='display-inline-block'>=</span> "
			+ "<span id='tooltipArr' class='display-inline-block'>arr[" 
			+ "<span id='tooltipI' class='display-inline-block'>i</span>]</span>"
			+ "</b></li>");
...
function copySmallerToBigger() {
	...
	$(".introjs-tooltiptext #ulTag").append("<li><b class='opacity00 ct-code-b-yellow' id='tooltipCopySmallValToArrI'> " 
			+ "<span class='display-inline-block'>arr[" 
			+ "<span class='display-inline-block' id='tooltipI'>i</span>]</span>"
			+ " <span class='display-inline-block'>=</span> "
			+ "<span id='tooltipSmallNo' class='ct-code-b-yellow display-inline-block'>smallerNumber</span>"
			+ "</b></li>");

	$("#copySmallValToArrI").effect("highlight", {color: 'yellow'}, 1000, function() {
		var l2 = $("#copySmallValToArrI").offset();
		$("#mainAnimation").css("z-index", "9999999");
		$("#tooltipCopySmallValToArrI").offset({"top": l2.top, "left": l2.left});
		tl.to("#tooltipCopySmallValToArrI", 1, {opacity: 1, top:0, left:0, onComplete: function() {
			$("#mainAnimation").css("z-index", "10000001");
			$("#tooltipCopySmallValToArrI").removeClass("opacity00");
			flipEffect("#tooltipSmallNo", $("#smallerVal").text(), function() {
				flipEffect("#tooltipI", $("#tmpVal").text(), function() {
					swapEffect("#tooltipSmallNo", "#arr" + $("#tmpVal").text(), function() {
						$(".color-green").removeClass("color-green");
...
function iIncrmtStep() {
	itr++;
	$(".introjs-tooltiptext #ulTag *").removeAttr("id");
	
	$(".introjs-tooltiptext #ulTag").append("<li><b class='opacity00 ct-code-b-yellow' id='tooltipIIncrmt'> "
											+ "<span id='tooltipI' class='display-inline-block'>i++</span>"
											+ "</b></li>");
...
function swapEffect(selector1, selector2, callBackFunction) { 
	$("#mainAnimation").css("z-index", "9999999");
	$(selector1).css("position", "relative").addClass("ct-code-b-yellow");
	...
	TweenMax.to(selector2, 0.5, {opacity:0, delay: 0.5, onComplete: function() {
		$(selector1).removeAttr("style").removeClass("ct-code-b-yellow");
...
function charAtEnd(elementId) {
	...
	<div class="ct-box-main">
		<div class='text-center'>
			<h1 class='label ct-demo-heading' id="heading">Selection sort smallest</h1>
		</div>
...
public class selectionSort {
	...
	<span id="methodBody">public static int[] doSelectionSort(int[] arr) {
		...
		<span id="firstForLoop">for (<span id="indexValue">int i = 0;</span><span
							id=condition1> i < n - 1</span>;<span id="increment1"> i++ </span>) {
			<span id="pos">int index = i;</span>
			
			<span id="secondForLoop">for (int j = i + 1; j < n; j++) {
				if (arr[j] < arr[index]) {
					index = j;
				}
			}</span>
				...
				<div id="mainAnimation" class="height border">
					<div id='cupsDiv' class='col-xs-12 text-center'>
						...
						<div id='tmpCupDiv' class='col-xs-2 display-none'>
							<div>
								<span id='tmpVal' class='cup-val opacity00'>0</span>
							</div>
						...
						<div id='smallerNumCupDiv' class='col-xs-2 opacity00'>
							...
							<div class='font-weight-bold'>smallerNum</div>
						</div>
					...
					<div id="forJavaCode" class="col-xs-offset-2 col-xs-8 opacity00">
						<pre>
for (<span id="iDcrl">int i = 0</span>;<span id="iCond"><span
								id="iIncond"> i </span>< <span>n - 1</span></span>; <span id="iIncre">i++</span>) {
	<span id="indexDeclrtn">int index = i;</span>
	for (<span id="jDcrl">int j = i + 1;</span> <span id="jCond"> j < n;</span> <span
								id="jIncre">j++</span>) {
		if (<span id='ifCndtn'>arr[j] < arr[index]</span>) {
			<span id='smallestIndex'>index = j;</span>
		}
	}
	<span id='smallerNumDclr'>int smallerNumber = arr[index];</span>
	<span id='copyArrItoArrIdx'>arr[index] = arr[i];</span>
	<span id='copySmallValToArrI'>arr[i] = smallerNumber;</span>
}
				</pre>
					</div>
				</div>
