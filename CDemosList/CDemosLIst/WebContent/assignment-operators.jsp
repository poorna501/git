...
$(document).ready(function() {
	...
	intro.onafterchange(function(targetElement) {
		...
		case "assignSpan":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				...
				var text = "Enter the x and y values."
		...
		case "operatorsDiv":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				...
				var text = "Select the type of <span class='ct-code-b-yellow'>assignment</span> operator and click on evaluation button."
				typing(".introjs-tooltiptext", text, function() {
					$(".introjs-nextbutton").hide();
				});
			});
		...
		case "animationDiv":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "To know working of another operator select <span class='ct-code-b-yellow'>assignment</span> again.<br/>"
	...
	var text = "<ul><li>In any programming language <span class='ct-code-b-green'>assignment</span> is the most commonly used <span class='ct-code-b-green'>operator</span> to "
		...
		+"operations</span>. They are:</li><ol><li>Simple assignment</li><li>Compound assignment</li><li>Assignment as expression</li></ol></ul>"
					...
					tl.to("#panel2", 1, {opacity:1, onComplete: function() {
						...
						$("#operatorExpX").fadeIn(800, function() {
							$("#operatorExpY").fadeIn(600, function() {
								...
								switchCondition();
								//$(".next-button").show();
								var text= "Each variable occupies 2 bytes of memory, because the variable hold the <span class='ct-code-b-yellow '>int</span> data type.";
								typing(".introjs-tooltiptext", text, function() {
									$(".introjs-nextbutton").hide();
									$(".next-button").show();
								}) 
