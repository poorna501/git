...
function introGuide() {
	...
	introcode.onbeforechange(function(targetElement) {
		...
		typingContent = '<ul><li><b>float data</b> represents real numbers with a decimal point.</li><li>It occupies <b>4 bytes(32 bits)</b> of memory to a float variable.</li><span id = "typing11"></span>'
		typing('#typing1',typingContent,function() {
			typingContent = '<li><b>float </b> value does not store in a normal integer format, it stores in <b>IEEE 754 standard</b> format.</li><span id = "typing111"></span></ul>'
			typing('#typing11',typingContent,function() {
				typingContent = '<ul><li><b>IEEE 754 standard</b> specifies the memory given for a float variable as </li></ul>'
				typing('#typing111',typingContent,function() {
					...
					$('#box0').fadeTo(1000,1,function() {
						...
						$("#box0").effect( "highlight",{color: 'yellow'}, 500,function() {
							...
							typingContent = '<b>Sign bit</b> stores the sign of a given float in 1 bit.'
			...
			$('.introjs-helperLayer').one('transitionend', function() {
				...
				$('#numDiv').fadeTo(1000,1,function() {
			 		$('#intpart').fadeTo(1000,1,function() {
						$('.introjs-tooltip').removeClass("hide");
						typingContent = 'First we convert the integral part(12) to binary and then fractional part(.625) to binary.'
						typing('.introjs-tooltiptext',typingContent,function() {
		...
		$('#int1Div').fadeTo(1000,1,function() {
			...
			$('.panel-text').append('<span id = step0></span>');
		 	typingContent = 'Steps to convert integral value to binary.<ul><li>Take the integral value <span id = "int12Div">12</span></li><span id = step2></span>'
		...
		$('.introjs-helperLayer').one('transitionend', function() {
			...
			TweenMax.to('#fracpart',0.5,{opacity:1,top : 0,left:0, onComplete:function() {
				...
				typingContent = 'Steps to convert fraction to binary are <ul id=one></ul>'
		...
		case "shiftdotDiv":
			$('.introjs-helperLayer').one('transitionend', function() {
				$('.introjs-nextbutton').hide();
				$('.introjs-tooltip').removeClass("hide");
				typingContent = 'The decimal point is shifted to get one value before it.'
				typing('.introjs-tooltiptext',typingContent,function() { 
					$('#shiftdotDiv').append('<div class = "col-xs-offset-3 col-xs-3 " id = "floatanimation">1<span id = "manValDiv"><span id = "num1">&nbsp;&nbsp;1</span><span id = "num2">&nbsp;&nbsp;0</span><span id ="num3">&nbsp;0</span><span id = "num4">&nbsp;.</span>1&nbsp;0&nbsp;1</span>&nbsp;x <span id = "power3"> 2</span><sup id = exp3><sup>0</sup></sup></span></div>');
						...
						setTimeout(function() {
							...
							typing('.introjs-tooltiptext',typingContent,function() {
								...
								$('.animation-nextbtn').click(function() { 
									...
									typingContent = 'The exponent value is.'
									typing('.introjs-tooltiptext',typingContent,function() {
										$('.introjs-tooltipbuttons').append("<a style='background-color:green' class='introjs-button animation-nextbtn'>Next &#8594;</a>"); 
										$('.animation-nextbtn').click(function() { 
											$('.animation-nextbtn').remove();
											typing('.introjs-tooltiptext','The mantissa is',function() {
												$('.introjs-tooltipbuttons').append("<a style='background-color:green' class='introjs-button animation-nextbtn'>Next &#8594;</a>");
												$('.animation-nextbtn').remove();
												$('#manval').text(100101); 
...
function animationbtn1() {
	...
	$('.introjs-tooltip').removeClass("hide");
	typingContent = '<b>Exponent</b> of the scientific notation is achieved by shifting the <b>radix</b> or decimal point to number of positions and adding with 127. It occupies 8 bits.</li>'
	typing('.introjs-tooltiptext',typingContent,function() {
		$('.introjs-tooltipbuttons').append("<a style='background-color:green' class='introjs-button animation-nextbtn'>Next &#8594;</a>"); 
		$('.animation-nextbtn').click(function() { 
			$('.animation-nextbtn').remove();	
			...
			$('.introjs-tooltip').removeClass("hide");
			typingContent = '<b>Mantissa</b> is the right side of radix or decimal point after exponent is achieved. It occupies 23 bits.'
			typing('.introjs-tooltiptext',typingContent,function() {
				...
				$('#floatBox').fadeTo(1000,1,function() {
					$('.byte-div').fadeTo(1000,1,function() {
						$('#addDiv').fadeTo(1000,1,function() {
							$('.introjs-tooltip').removeClass('hide');
							typingContent = 'The float variable is converted to binary and stored in memory.<br>To know how a float variable is converted into binary and stored in memory, click on next button.'
							typing('.introjs-tooltiptext',typingContent,function() { 
...
function divisionClick(divisionStep) {
				...
				TweenMax.fromTo("#multiplier,#line",.5,{rotationX:-90},{rotationX:0,opacity:1,onComplete:function() {
					TweenMax.to("#remainder",.5,{opacity:1,onComplete:function() {
						...
						TweenMax.to("#binSpan1",.5,{opacity:1,top:0,left:0,onComplete:function() {
							...
							$('.introjs-tooltip').removeClass('hide');
							typingContent = 'We store the remainder.'
							typing('.introjs-tooltiptext',typingContent,function() {
								$("#divisionBtn").show();
							});
						}})
	...
	if (divisionStep == 3) {
		...
		typing('#step2',typingContent,function() { 
			...
			TweenMax.to("#dividend",.5,{top:0,left:0,onComplete:function() {
				...
				$("#multiplier").text(quotient * 2); 
				$('.introjs-tooltip').removeClass('hide');
				typingContent = 'In the next step, we take the quotient of previous step as divisor and divide it by 2.'
				typing('.introjs-tooltiptext',typingContent,function() {
					$("#divisor").fadeTo("slow","1",function() {
						TweenMax.to("#quotient",.5,{opacity:1,onComplete : function() {
							TweenMax.fromTo("#multiplier,#line",.5,{rotationX:-90},{rotationX:0,opacity:1,onComplete:function() {
								...
								TweenMax.to("#remainder",.5,{opacity:1, onComplete : function() {
									...
									TweenMax.to("#binSpan1",.5,{opacity:1,top:0,left:0,onComplete:function() {
										$("#binSpan1").removeAttr('id');
										$('.introjs-tooltip').removeClass('hide');
										typingContent = 'We append the remainder to the left of the previous remainder.'
										typing('.introjs-tooltiptext',typingContent,function() {
											$("#divisionBtn").show();
										});
									}})
	...
	if (divisionStep == 4) {
		...
		typing('#step3',typingContent,function() { 
			$('.introjs-tooltip').removeClass('hide');
			typingContent = 'We repeat the above steps i.e. we divide the quotient by 2, till we get the quotient as 0.'
			typing('.introjs-tooltiptext',typingContent,function() {
				setTimeout(function() {
					decimal();
				},1500);
	...
	if (divisionStep == 5) {
		...
		setTimeout(function() {
			...
			TweenMax.to("#fracBinSpan0",0.5,{delay:0.5,top:0,left:0,onComplete:function(){
				$("#fracBinSpan0").text('1');
				$('.introjs-tooltip').removeClass('hide');
				typingContent = 'We take the integral value before decimal and store it.'
				typing('.introjs-tooltiptext',typingContent,function() {
	...
	if (divisionStep == 6) {
		...
		TweenMax.to("#cpyMulFraction",.5,{opacity:1,top:0,left:0,onComplete:function() {
			$('.introjs-tooltip').removeClass('hide');
			typingContent = 'We take the fraction part(.25) after the decimal and multiply it with 2.'
			typing('.introjs-tooltiptext',typingContent,function() {
				rightDec = rightDec * 2;
				...
				TweenMax.fromTo("#mul2",.5,{y:-90},{opacity:1,y:0,onComplete:function() {
					...
					TweenMax.to("#fracBinSpan1",0.5,{delay:0.5,top:0,left:0,onComplete:function(){
						$("#FractionalBinaryValue > span").css("padding","0px 3px")
						$("#fracBinSpan1").text('0');
						typingContent = 'We multiply the fractional part with 2 and take the integral part before the decimal and append it to the right of the previous value.'
						typing('.introjs-tooltiptext',typingContent,function() {
							$("#divisionBtn").show();
						});
					}});
	...
	if (divisionStep == 7) {
		...
		$('.introjs-tooltip').removeClass('hide');
		typingContent = 'We repeat the above steps i.e.we multiply the fractional part with 2 and take the integral part before the decimal and append it to the right of the previous value till we get the fractional part as 0.0000'
		typing('.introjs-tooltiptext',typingContent,function() {
	...
	if (divisionStep == 8) {
		...
		typing('#four',typingContent,function() {  
			...
			typing('#cpyMulFraction4',typingContent,function() { 
				$('.introjs-tooltip').removeClass('hide');
				typingContent = 'By combining the result of conversion of decimal-binary and fraction-binary.'
				typing('.introjs-tooltiptext',typingContent,function() {  
					$(".introjs-nextbutton").show();
				});
			});
...
function decimal() {
	...
	if (quotient > 0) {
		...
		typing('#desc',typingContent,function() { 
			...
			$('.introjs-tooltip').removeClass('hide');
			typingContent = 'Now we convert the fractional part to binary.'
			typing('.introjs-tooltiptext',typingContent,function() {
				$('.introjs-nextbutton').show();
			});
		});
...
<div class = 'ct-box-main'>
	...
	<div class='buttons-div text-center margin4'>
		...
		<div class = 'col-xs-11 animation-div margin10' id = 'animationDiv'>
			<div class = 'row'>
				...
				<div class = 'row'>
				<div class = 'col-xs-6 int-part' id = 'intpart'>
					<div class = 'col-xs-5'>
						...
						<div class = 'col-xs-6 int-div box-border opacity00' id = 'int2Div'>
						</div>
				</div>
				<div class = 'col-xs-6 fract-part margin4' id = 'fractpart'>
					<div class = 'col-xs-6'>
					...
					<div class = 'col-xs-5 int-div box-border opacity00' id = 'int4Div'>
					</div>
				</div>
				</div>
			
			<div class = 'row'>
				<div class = 'col-xs-offset-3 col-xs-6 final-div opacity00 margin4' id = 'finalDiv'>
				<div id = 'finalDivtext' class= "marginleft5"></div>
					<div id = 'shiftdotDiv' class = 'margin4'></div>
					<br>
					<div id = 'lastbitDiv' class = ' opacity00 margin4'>
						<span id = 'signvalbit' class = 'col-xs-2'>1 bit</span>
						<span id = 'expvalbit' class = 'col-xs-2'>8 bits</span>
						<span id = 'manvalbit' class = 'col-xs-7'>23 bits</span>
					</div>
					<br>
					<div id = 'lastDiv' class = 'col-xs-offset-1 opacity00'>
						<span id = 'signval' class = 'col-xs-1'></span>
						<span id = 'expval' class = 'col-xs-2'></span>
						<span id = 'manval' class = 'col-xs-2'></span>
					</div>
					<div id = 'lastvalDiv' class = 'opacity00'>
						<span id = 'signvalname' class = 'col-xs-offset-1 col-xs-1'>sign</span>
