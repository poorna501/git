	...
	introjs.onafterchange(function(targetElement) {
		...
		case "description":
			...
			var text = "<ul><li>If the control string contains non white space characters other than conversion" +
				...
				" character do not match, the scanf ( ) function stops.</li> <li>If the character matches, that character is"+
				" read from the input data and ignored.</li> <li>Then scanf() continues processing the control string.</li>"+
				" <li>This facilitates the user to enter the inputs in any convenient form.</li></ul>";
			typing("#desText", text, function() {
				var text2 = "Let us see how it works with <span class='ct-code-b-yellow'>dot</span>.";
		...
		case "codeAnimation":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Now we will see the working of <span class='ct-code-b-yellow'>scanf()</span> function by " 
							+ " taking three variables in this code.";
		...
		case "varDeclaratn":
			$(".introjs-nextbutton").hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Here we are declaring three integer variables day, month and year.";
				typing(".introjs-tooltiptext", text, function() {
					$(".introjs-nextbutton").show();
				});
			});
		...
		case "addressDiv":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				...
				if (introjs._currentStep == 3) {
					...
					var text = "This is the location of given three integer variables day, month and year allocated at respected "  
					...
					$("#givenNum3").offset({"top": l3.top, "left": l3.left});
					...
					$("#scanNum1").delay(1000).queue(function() {
						...
						tl.to("#givenNum1", 1, {opacity: 1, top:0, left:0, onComplete: function() {
							...
							$("#dot1").addClass("zIndex");
							$("#dot1").addClass("blinking-white");
							
							$("#dot1").delay(1000).queue(function() {
								$("#dot1").removeClass("zIndex");
								$("#dot1").removeClass("blinking-white");
								
								var txt1 = "Here dot is <span class='ct-code-b-yellow'>ignored</span>. <span id='appendTxt'></span>";
								typing(".introjs-tooltiptext", txt1, function() {
									$("#dBlink2").delay(1000).queue(function() {
										...
										$("#scanNum2").delay(1000).queue(function() {
											...
											tl.to("#givenNum2", 1, {opacity: 1, top:0, left:0, onComplete: function() {
												...
												$("#dot2").addClass("zIndex");
												$("#dot2").addClass("blinking-white");
												
												$("#dot2").delay(1000).queue(function() {
													$("#dot2").removeClass("zIndex");
													$("#dot2").removeClass("blinking-white");
													
													var txt2 = "Again dot is <span class='ct-code-b-yellow'>ignored</span> here. " 
																+ "<span id='appendTxt2'></span>";
													typing("#appendTxt", txt2, function() {
														$("#dBlink3").delay(1000).queue(function() {
															$("#dBlink3").addClass("blinking-white");
															$("#dBlink3").addClass("zIndex");
															
															$("#scanNum3").delay(1000).queue(function() {
																$("#dBlink3").removeClass("blinking-white");
																$("#dBlink3").removeClass("zIndex");
																$("#scanNum3").addClass("blinking-white");
																$("#scanNum3").addClass("zIndex");
																$("#givenNum3").addClass("zIndex");
																
																tl.to("#givenNum3", 1, {opacity: 1, top:0, left:0, onComplete: function() {
																	$("#givenNum3").removeClass("opacity00");
																	$("#scanNum3").removeClass("blinking-white");
																	$("#scanNum3").removeClass("zIndex");
																	$("#givenNum3").removeClass("zIndex");
																	var text = "Now given values are stored in day, month and year respectively " 
																				+ "<span class='ct-code-b-yellow'>without</span> dots.";
																	typing("#appendTxt2", text, function() {
																		$(".introjs-nextbutton").show();
																	});
																}});
															});
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				if (introjs._currentStep == 5) {
					...
					typing("#inputVal", text, function() {
						var text2 = "Enter <b>3</b> numbers at the blinking cursor seperated with <span class='ct-code-b-yellow'>dot</span>." 
									+ " for example if you want to give <b>03</b>, <b>05</b> and <b>92</b>, give it as <b>03.05.92</b>";
						typing(".introjs-tooltiptext", text2, function() {
							charAtEnd("num1");
							arr = [];
					...
					$(".introjs-helperLayer").one("transitionend", function() {
						var text = "day = "+$("#givenNum1").text()+" month = "+$("#givenNum2").text()+" year = "+$("#givenNum3").text();
		...
		case "scanf":
			$(".introjs-nextbutton").hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Here we are implementing the <span class='ct-code-b-yellow'>scanf()</span> function " 
							+ " with <span class='ct-code-b-yellow'>%d</span>, which are seperated by <b>dot</b>.";
				typing(".introjs-tooltiptext", text, function() {
					$(".introjs-nextbutton").show();
				});
			});
		...
		case "finalPrintf":
			$(".introjs-nextbutton").hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Now here we are printing day, month and year.";
				typing(".introjs-tooltiptext", text, function() {
					$(".introjs-nextbutton").show();
				});
			});
...
<div class="main-div col-xs-12" id="mainDiv">
	...
	<span id="varDeclaratn">int day, month, year;</span>
	<span id="printf">printf("Enter three numbers : ");</span>
	<span id="scanf">scanf("<span id='percentile'><span id='dBlink1'>%d</span><span id='dot1'>.</span><span id='dBlink2'>%d</span><span id='dot2'>.</span><span id='dBlink3'>%d</span></span>", <span id='scanNum1'>&day</span>, <span id='scanNum2'>&month</span>, <span id='scanNum3'>&year</span>);</span>
	<span id="finalPrintf">printf("day = %d month = %d" year = %d, day , month, year);</span>
	</pre>
	</div>
