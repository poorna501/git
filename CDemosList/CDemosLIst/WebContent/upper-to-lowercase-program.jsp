...
<div class="col-xs-4">
	<div class="address-box" id="addressBox">
  		<div class="col-xs-12 " id="animationBox">
			<div class="col-xs-6">
  				<div class="panel-group visibility-hidden" id="panelBox">
...
$(document).ready(function() {
	...
	/* $('.input-char').keydown(function(e) {
		...
		if (this.value.length == 0 || this.value) {
			if (!/^[a-zA-Z]*$/g.test(this.value)) {
				$(".introjs-tooltiptext").append("<span id='errorText' class='ct-code-b-red'>Enter only alphabets</span>");
		    } else {
		    	console.log();
	...
	intro.onafterchange(function(targetElement) {
		...
		case "preBody" :
			...
			$('.introjs-helperLayer ').one('transitionend', function() {
				typing(".introjs-tooltiptext", "Here is the program to read to a character and print a character.", 10, "",function() {
					$('.introjs-nextbutton').show();
				});
			});
			break;
		...
		case "line5" :
			...
			$('.introjs-nextbutton').hide();
			$('.introjs-helperLayer ').one('transitionend', function() {
				typing(".introjs-tooltiptext", "getchar() is library function which reads only 1 char from keyboard.", 10, "",function() {
					$('.introjs-nextbutton').show();
				});
			});
			break;
		...
		case "line7" :
			...
			$('.introjs-helperLayer ').one('transitionend', function() {
				typing(".introjs-tooltiptext", "here, ch + 32 is ASCII code value, which converts into lowercase.", 10, "",function() {
					$('.introjs-nextbutton').show();
				});
			});
			break;
		...
		case "line8" :
			$('.introjs-nextbutton').hide();
			$('.introjs-helperLayer ').one('transitionend', function() {
				typing(".introjs-tooltiptext", "putchar() is used to write a character on the output screen.", 10, "",function() {
					$('.introjs-nextbutton').show();
				});
			});
			break;
		...
		case "inputChar" :
			$('.introjs-nextbutton').hide();
			$('.introjs-helperLayer ').one('transitionend', function() {
				typing(".introjs-tooltiptext", "Enter any uppercase letter. <span id='errorText'></span>", 10, "",function() {
					$("#inputChar").focus();
		...
		case "addressBox" :
			...
			$('.introjs-helperLayer ').one('transitionend', function() {
				$("#panelBox").removeClass("visibility-hidden").addClass("animated zoomIn").one('animationend', function() {
					...
					$(".arrowId").removeClass("visibility-hidden");
					$(".byteId").removeClass("visibility-hidden");
					typing(".introjs-tooltiptext", "Arrows shows that : <ul><li><span class='ct-code-b-green'>ch</span> is a varaible.</li><li><span class='ct-code-b-green'>" + $('#inputChar').val() + "</span> stores only 1 byte.</li><li><span class='ct-code-b-green'>1024</span> is the address.</li></ul>", 10, "",function() {
						$('.introjs-nextbutton').show();
					});
				});
			});
		...
		case "panelBox" :
			...
			$('.introjs-helperLayer ').one('transitionend', function() {
				...
				t1.to("#panelBodyUpperCaseId", 0.5, {opacity:1, rotationX: 0, onComplete: function() {
					...
					typing(".introjs-tooltiptext", "The value of uppercase is converted to lowercase and is stored in ch.", 10, "",function() {
						$('.introjs-nextbutton').show();
					});
				}});
		...
		case "hiddenTotalEnterChar" :
			$('.introjs-helperLayer ').one('transitionend', function() {
				...
				typing(".introjs-tooltiptext", "The converted lowercase letter is stored on the output screen.", 10, "",function() {
	...
	typing(".introjs-tooltiptext", "Let us learn execution of sample program to convert upper to lowercase letters.", 10, "",function() {
		$('.introjs-nextbutton').show();
	});
