...
<span id = "sopLine2">printf("/n<span id = "persentageD2" >%0<span id = 'number2' contenteditable = 'true', spellcheck = 'false', maxlength = '1'>6</span>d</span>",<span id = "aValue2">aValue</span>);</span>
						</pre>
					</div>
				</div>
				<div class = "col-xs-5">
			...
			switch (elementId) {
				case "printfDefinition" :
					...
					text = 'The <span class = "ct-code-b-red">printf()</span> function with'+
						' <span class = "ct-code-b-red">%</span>[<span class = "ct-code-b-red">flag</span>'+
						' (<span class = "ct-code-b-red">0</span>)][field width]d</span>.<br> If the number of characters of the '+
						'output data is <span class = "ct-code-b-red">less than</span>'+
						' the specified field width then the output is printed with leading <span class = "ct-code-b-red">zeros'+
						' </span> to fill the specified field width.'+
				...
				case "codeDiv" :
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						text = 'Let us learn how the <span class = "ct-code-b-yellow">printf()</span> function with'+
							' <span class = "ct-code-b-yellow">zero</span> and '+
				...
				case "sopLine" + sopLineCount  :
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						if (introcode._currentStep == 4) {
							...
							$('.introjs-tooltip').removeClass('hide');
							$('[contenteditable = "false"]').attr('contenteditable', 'true');
							text = 'Here we use <span class = "ct-code-b-yellow">%0<span class = "keyValue">6</span>d</span> is also used to '+
									...
									'<span class = "ct-code-b-yellow">field width</span> (%0'+
									'<span class = "ct-code-b-yellow"><span class = "keyValue">6</span></span>d).<br>'+
									'Let us see how its work.<br>'+
				...
				case "outputDiv" :
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						if (introcode._currentStep == 5) {
							...
							if (length < number) {
								$('.introjs-tooltip').removeClass('hide');
								text = 'Here we use a <span class = "ct-code-b-yellow">flag</span> (%'+
										' <span class = "ct-code-b-yellow">0</span>'+ $("#number2").text() +')</span> to says that '+
	...
	function outputReservedPositions(text) {
		...
		$("#persentageD" + sopLineCount).effect( "transfer", { to: $("#appendDiv" + sopLineCount), className: "ui-effects-transfer" }, 1000 , function(){
			...
			text = 'The number of characters of the <span class = "ct-code-b-yellow">output</span>'+
					...
					'</span>) will be printed to the <span class = "ct-code-b-yellow">output</span>, after '+
					'the spaces will be filed with <span class = "ct-code-b-yellow">zeros</span>.';
			typing('.introjs-tooltiptext', text, typingInterval, 'white', function(){
				$('.introjs-tooltipbuttons').append("<a class='introjs-button introjs-duplicate-nextbutton' " +
