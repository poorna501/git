...
<div class="col-sm-12 text-center">
	<div class="margin-padding-css text-center" >
		...
		<div class="col-sm-offset-3 col-sm-3">
			<h3><span class="ct-demo-heading label label-default" id="titleName">Program to print Character</span></h3>
		</div>
	</div>
</div>
...
$(document).ready(function() {
	...
	intro.onafterchange(function(targetElement) {
		...
		case "line7" :
			...
			$('.introjs-helperLayer ').one('transitionend', function() {
				typing(".introjs-tooltiptext", "putchar() is used to write a character on to the output screen.", 10, "",function() {
					$('.introjs-nextbutton').show();
				});
			});
			break;
			...
			$('.introjs-nextbutton').hide();
				$('.introjs-helperLayer ').one('transitionend', function() {
					$("#panelBox").removeClass("visibility-hidden").addClass("animated zoomIn").one('animationend', function() {
						typing(".introjs-tooltiptext", "The variable ch is stored in certain memory location.", 10, "",function() {
							$('.introjs-nextbutton').show();
						});
					});
				});
					...
					$('#addressId').removeClass("visibility-hidden").addClass("animated zoomIn").one('animationend', function() {
						$(".arrowId").removeClass("visibility-hidden").addClass("animated zoomIn").one('animationend', function() {
							$(".byteId").removeClass("visibility-hidden").addClass("animated zoomIn").one('animationend', function() {
								typing(".introjs-tooltiptext", "Arrows shows that : <ul><li><span class='ct-code-b-green'>ch</span> is a varaible.</li><li><span class='ct-code-b-green'>" + $('#inputChar').val() + "</span> stores only 1 byte.</li><li><span class='ct-code-b-green'>1024</span> is the address.</li></ul>", 50, "",function() {
									$('.introjs-nextbutton').show();
								});
							});
						});
		...
		case "hiddenTotalEnterChar" :
			$('.introjs-helperLayer ').one('transitionend', function() {
				...
				typing(".introjs-tooltiptext", "The entered character is printed on to the output screen.", 10, "",function() {
					$('.introjs-nextbutton').show();
				});
			});
			break;
	...
	typing(".introjs-tooltiptext", "Let us learn execution of sample program for reading (or) printing character.", 10, "",function() {
		$('.introjs-nextbutton').show();
	});
