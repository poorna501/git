		...
		var elementId = targetElement.id;
			switch (elementId) {
				case "program" :
					...
					text = 'Here we will learn how the <span class="ct-code-b-yellow">post-decrement</span>'+
				...
				case "yVariableDeclararionLine"  :
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						case "working" :
							$('.introjs-tooltip').removeClass('hide');
							text = 'First let us know how the <span class="ct-code-b-yellow">post-Decrement operator</span> '+
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						TweenMax.to('.animation-div1', 1, {opacity: 1, onComplete: function() {
							...
							svgBoxAnimation(0, function(){
								$('.introjs-tooltip').removeClass('hide');
								text = 'When it is used in an expression, the <span class="ct-code-b-yellow">post-decrement</span> '+
										...
										'<span class="ct-code-b-yellow">x</span> will be <span class="ct-code-b-yellow">decremented</span>'+
				...
				case "singleStatement"  :
					...
					$('.introjs-helperLayer').one('transitionend', function() {
							$('.introjs-tooltip').removeClass('hide');
							text = 'Let us see how <span class="ct-code-b-yellow">post-decrement operator</span> works on a single statement.';
							typing('.introjs-tooltiptext', text, typingInterval, 'white', function(){
								$('.introjs-nextbutton').show();
							});
					});
	...
	function xValuedecrementByOne() {
		...
		$(".introjs-duplicate-nextbutton").click(function() {
			...
			TweenMax.to('.animation-div3', 1, {opacity: 1, onComplete: function() {
				$('.introjs-tooltip').removeClass('hide');
				text = 'Now the <span class="ct-code-b-yellow">x</span> value will be '+
