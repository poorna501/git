...
<script type="text/javascript">
	...
	function introJsGuide() {
		...
		introjs.setOptions({
			steps : [ {
				...
				element : '#statement',
				intro : 'The above statement prints the value of <b class="ct-code-b-yellow">value</b>.',
				position : 'bottom'
			}, {
				element : '#outputDiv',
				tooltipClass : 'hide'
		...
		introjs.onafterchange(function(targetElement) {
			...
			case "docon" :
				...
				$('.introjs-helperLayer').one('transitionend', function () {
					...
					var text = "<b class='ct-code-b-yellow'>doWhile</b> is an <b class='ct-code-b-yellow'>exit controlled loop</b> where first the statements are executed atleast one time.";
			...
			case "update" :
				...
				$('.introjs-helperLayer').one('transitionend', function () {
					var text = "The post-increment operator increments the value of <b class='ct-code-b-yellow'> variable value</b>" 
						+ " by <b class='ct-code-b-yellow'>1</b>. Now  <b class=''>" 
			...
			case "mainEnd" :
				...
				$('.introjs-helperLayer').one('transitionend', function () {
					$('.introjs-tooltipbuttons').hide();
					var text = "The control comes out of the <b class='ct-code-b-yellow'>do-while</b> loop and the program terminates.";
					typing(".introjs-tooltiptext", text, function() {
						$('.introjs-tooltipbuttons').show();
						$('.introjs-nextbutton').removeClass("opacity00");
					});
	...
	$(document).ready(function() {
		...
		$(".incrementBtn").click(function() {
			$(this).addClass("hidden");
			var text = " The post-increment operator increments the value of variable <b class='ct-code-b-yellow'>value</b> " 
...
<div class='col-xs-12'>
	...
	int main() {
	<span id='initialization'>int value = <span id='initializationValue' class="allowNumbers position-relative" maxlength="1" contenteditable=false placeholder=" ">1</span>;</span><span class="cup-bg position-absolute opacity00"><span class="hide-sm cup"><i class="fa fa-coffee fa-inverse fa-2"></i><h5 class="num-position"><span id='cup_num'><b>value</b></span>= <h6 id="cupValue"></h6></h5></span></span>
	<span id='doWhile'><span id ="docon">do {</span>
