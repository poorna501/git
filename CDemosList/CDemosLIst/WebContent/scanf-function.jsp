...
function introGuide() {
	...
	introjs.onafterchange(function(targetElement) {
		...
		case "description":
			...
			var text = "scanf() function is used to read data from keyboard. Here we will discuss about the working of scanf() function."+
			"in scanf() function.";
		...
		case "codeAnimation":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Now we will see the working of <span class='ct-code-b-yellow'>scanf()</span> function " 
							+ " by taking two variables in this code.";
						...
						tl.to("#givenNum1", 1, {opacity: 1, top:0, left:0, onComplete: function() {
							...
							$("#scanNum2").delay(1000).queue(function() {
								...
								tl.to("#givenNum2", 1, {opacity: 1, top:0, left:0, onComplete: function() {
									...
									var text = "Now given values are stored in a and b.";
									typing(".introjs-tooltiptext", text, function() {
										$(".introjs-nextbutton").show();
									});
								}});
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				...
				if (introjs._currentStep == 5) {
					...
					typing("#inputVal", text, function() {
						var text2 = "Enter <b>two</b> numbers at blinking cursor. press <span class='ct-code-b-yellow'>space</span> " 
		...
		case "scanf":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Here we are implementing the <span class='ct-code-b-yellow'>scanf()</span> function " 
							+ " with <span class='ct-code-b-yellow'>%d</span> because the given numbers are integers.";
				typing(".introjs-tooltiptext", text, function() {
					$(".introjs-nextbutton").show();
				});
			});
		...
		case "restart":
			$(".introjs-helperLayer").one("transitionend", function() {
				$("#restart").removeClass("visibility-hidden");
...
<div class="main-div col-xs-12" id="mainDiv">
	...
	<span id="scanf">scanf("<span id='percentile'><span id='dBlink1'>%d</span><span id='dBlink2'>%d</span></span>", <span id='scanNum1'>&a</span>, <span id='scanNum2'>&b</span>);</span>
...
<div class="col-xs-12 margin-top-20 text-center"><span id="restart" class="btn btn-warning visibility-hidden">Restart</span></div>
</body>
</html>