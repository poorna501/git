				...
				<div class = 'col-xs-12'>
					<div class = 'col-xs-8 col-xs-offset-2' id = "animationDiv1">
						<div class = 'col-xs-12 text-center animation-div1'>
							<span id = 'yVariableLine' class = "box-padding ">int y = <span class = "box-padding" id = "predecrement">--x</span></span>
							<svg class = 'svg-css'>
...
var sopLineCount = 1;
		...
		var elementId = targetElement.id;
			switch (elementId) {
				case "program" :
					...
					text = 'Here we will learn how the <span class="ct-code-b-yellow">pre-decrement</span>'+
							' operator works on a simple statement and an expression.';
				...
				case "yVariableDeclararionLine"  :
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						case "working" :
							$('.introjs-tooltip').removeClass('hide');
							text = 'First let us know how the <span class="ct-code-b-yellow">pre-Decrement operator</span> '+
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						TweenMax.to('.animation-div1', 1, {opacity: 1, onComplete: function() {
							svgBoxAnimation(0, function(){
								$('.introjs-tooltip').removeClass('hide');
								text = 'When it is used in an expression, the <span class="ct-code-b-yellow">pre-decrement</span> '+
										' operator first the value of <span class="ct-code-b-yellow">x</span> will be decrement by '+
										' <span class="ct-code-b-yellow">1</span> and then the value of '+
										'<span class="ct-code-b-yellow">x</span> will be  assigned to the variable <span class="ct-code-b-yellow">y</span>.';
								typing('.introjs-tooltiptext', text, typingInterval, 'white', function(){
									xValuedecrementByOne();
								});
							});
						}});
					});
				...
				case "singleStatement"  :
					...
					$('.introjs-helperLayer').one('transitionend', function() {
							$('.introjs-tooltip').removeClass('hide');
							text = 'Let us see how <span class="ct-code-b-yellow">pre-decrement operator</span> works on a single statement.';
							typing('.introjs-tooltiptext', text, typingInterval, 'white', function(){
								$('.introjs-nextbutton').show();
							});
					});
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						$("#singleStatement").effect( "transfer", { to: $("#singleStatementDiv"), className: "ui-effects-transfer" }, 1000 , function(){
							TweenMax.to('.animation-div6', 1, {opacity: 1, onComplete: function() {
								$('.introjs-tooltip').removeClass('hide');
								text = 'The <span class="ct-code-b-yellow">x</span> value will be decrement by <span class="ct-code-b-yellow">1</span>.';
								typing('.introjs-tooltiptext', text, typingInterval, 'white', function(){
	...
	function predecrementOperatorAnimation() {
		var left = 57;
		$('.introjs-tooltip').removeClass('hide');
		text = ' First the <span class="ct-code-b-yellow">x</span> value  <span class="ct-code-b-yellow">'+
				$("#xvalue").text() +'</span>  will be <span class="ct-code-b-yellow">decrement</span>'+
			...
			$(".introjs-duplicate-nextbutton").click(function() {
				...
				TweenMax.to($("#xCupValue"), 1, {rotationX : -90, onComplete:function() {
					...
					TweenMax.to($("#xCupValue"), 1, {rotationX : 0, onComplete:function() {
						$(".x-cup").removeClass("blinking");
						$('.introjs-tooltip').removeClass('hide');
						text = 'Now the <span class="ct-code-b-yellow">x</span> value   <span class="ct-code-b-yellow">'+
						...
						typing('.introjs-tooltiptext', text, typingInterval, 'white', function(){
							...
							$(".introjs-duplicate-nextbutton").click(function() {
								...
								/* tl.to("#yCupValue", 1, {top :0, left:left, onComplete:function(){ */
	...
	function xValueAssignedToVariabley() {
		...
		$(".introjs-duplicate-nextbutton").click(function() {
			...
			TweenMax.to('.animation-div3', 1, {opacity: 1, onComplete: function() {
				$('.introjs-tooltip').removeClass('hide');
				text = 'Now the <span class="ct-code-b-yellow">x</span> value assign to the '+
	...
	function xValuedecrementByOne() {
		...
		$(".introjs-duplicate-nextbutton").click(function() {
			...
			TweenMax.to('.animation-div2', 1, {opacity: 1, onComplete: function() {
				$('.introjs-tooltip').removeClass('hide');
				text = ' First the <span class="ct-code-b-yellow">x</span> value will be '+
