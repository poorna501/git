...
<script>
	...
	$(document).ready(function() {
		...
		intro.onafterchange(function(targetElement) {
			...
			case "heading":
				...
				$(".popover").css("top" , "0");
				var text = "This will show how the c program will run in the system.";
			...
			case "animationDiv":
				...
				$(".introjs-helperLayer ").one('transitionend', function() {
					TweenMax.to("#user", 1, {"opacity" : "1", onComplete:function() {
						...
						$('#user').popover('show');
						var text = "User is the person who sit infront of the system to write different programs.";
	...
	function hardware() {
		...
		TweenMax.to("#hardware", 1, {"opacity" : "1", onComplete:function() {
			...
			var text = "This is the machine which knows only <b>machine language</b> i.e, 0's and 1's.";
	...
	function os() {
		...
		TweenMax.to("#os", 1, {"opacity" : "1", onComplete:function() {
			...
			$('#os').popover('show');
			var text = "<ul>"
							+ "<li>Operating System acts as interface between user and hardware, Which provides communication between them.</li>"
							+ "<li>It consists of <b>Softwares</b>.</li>" 
	...
	function typeTwoinfo() {
		...
		var text = "System software is a collection of system programs which run background" 
		...
		TweenMax.to("#line3", 1, {attr:{x2: "65%", y2: "51.6%" }, onComplete:function(){
			...
			TweenMax.to("#line11", 1, {attr:{x2: "67%", y2: "51.5%" }, onComplete:function(){
				TweenMax.to("#compiler", 1, {"opacity" : "1", onComplete:function() {
					...
					$(".popover").css("top" , "0");
					var text="<ul><li><b>complier:</b> It is a program which translates a high level language program" 
								+ " into a machine language.Compiler compiles every program once at a glance.</li></ul>";
		...
		TweenMax.to("#line3", 1, {attr:{x2: "65%", y2: "58.6%" }, onComplete:function(){
			...
			TweenMax.to("#line12", 1, {attr:{x2: "67%", y2: "58.5%" }, onComplete:function(){
				TweenMax.to("#assembler", 1, {"opacity" : "1", onComplete:function() {
					var text="<ul><li><b>Assembler: </b>which translates an assembly language program into a machine language program" 
		...
		TweenMax.to("#line3", 1, {attr:{x2: "65%", y2: "65.6%" }, onComplete:function(){
			...
			TweenMax.to("#line13", 1, {attr:{x2: "67%", y2: "65.5%" }, onComplete:function(){
				TweenMax.to("#linker", 1, {"opacity" : "1", onComplete:function() {
					var text="<ul><li><b>linker: </b>Tool that merges the object files produced by separate compilation or assembly and" 
								+ " creates an executable file.</li></ul>";
					typing("#popover1", text, function(){
		...
		TweenMax.to("#line15", 1, {attr:{x2: "67%", y2: "79%" }, onComplete:function(){
			TweenMax.to("#interpreter", 1, {"opacity" : "1", onComplete:function() {
				var text="<ul><li><b>Interpreter: </b>An interpreter is a program which translates statements of a program into machine code." 
							...
							+ " program, translates it and executes it. Then it reads the next statement.</li></ul>";
				typing("#popover1", text, function(){
	...
	function connection1() {
		...
		TweenMax.to("#line5", 1, {attr:{x2: "23%", y2: "51.5%" }, onComplete:function() {
			...
			TweenMax.to("#arrowMark5", 1, {attr:{x2: "34.5%", y2: "51.5%" }, onComplete:function() {
				...
				var text="User wants to write a letter and saves it in computer for future purpose then user" 
					+ " use the application software MS-word to write the letter and saved it.";
	...
	function connection12() {
		...
		TweenMax.to("#arrowMark6", 1, {attr:{x2: "63.5%", y2: "51.5%" }, onComplete:function() {
			...
			var text="When the user clicks on save button the complier first converts the entire high level language data to low level language.";
	...
	function connection13() {
		...
		TweenMax.to("#line4", 1, {attr:{x2: "79%", y2: "51.5%" }, onComplete:function() {
			...
			TweenMax.to("#arrowMark7", 1, {attr:{x2: "79%", y2: "17.5%" }, onComplete:function(){
				...
				var text="After converting into low level, the file will be stored in the memory.";
	...
	function retrive1() {
		...
		TweenMax.to("#line17", 1, {attr:{x2: "79%", y2: "51.5%" }, onComplete:function() {
			...
			TweenMax.to("#arrowMark11", 1, {attr:{x2: "76%", y2: "51.6%" }, onComplete:function() {
				...
				var text="If user want to retrive the saved file then the machine data of that file will be sent to complier.";
	...
	function retrive11() {
		...
		TweenMax.to("#arrowMark12", 1, {attr:{x2: "45%", y2: "51.5%" }, onComplete:function() {
			...
			var text="This will again convert into high level language i.e, user language.";
		...
		TweenMax.to("#line18", 1, {attr:{x2: "79%", y2: "51.5%" }, onComplete:function() {
			...
			TweenMax.to("#line19", 1, {attr:{x2: "23%", y2: "51.4%" }, onComplete:function() {
				...
				TweenMax.to("#arrowMark13", 1, {attr:{x2: "23%", y2: "17.6%" }, onComplete:function() {
					...
					var text="Now, it will display to the user.";
	...
	function connection2() {
		...
		TweenMax.to("#line16", 1, {attr:{x2: "23%", y2: "78.7%" }, onComplete:function() {
			...
			TweenMax.to("#arrowMark10", 1, {attr:{x2: "34.5%", y2: "78.5%" }, onComplete:function() {
				...
				var text="In the same way user want to develop an application through programs then the user can write " 
					+ "programs using 'c' application software.";
	...
	function connection21() {		
		...
		TweenMax.to("#arrowMark9", 1, {attr:{x2: "64.5%", y2: "51.5%" }, onComplete:function() {
			...
			var text="The source code written by the user will be send to complier to check syntax errors and to convert into machine level language.";
			...
			TweenMax.to("#arrowMark7", 0, {attr:{x2:"79%", y2:"51.5%" }, onComplete:function() {
				...
				TweenMax.to("#line4", 1, {attr:{x2: "79%", y2: "51.5%" }, onComplete:function() {
					...
					TweenMax.to("#arrowMark7", 1, {attr:{x2: "79%", y2: "17.5%" }, onComplete:function(){
						...
						var text="The system will execute the program and the result will be stored as machine level language.";
						typing("#popover9", text, function(){
	...
	function retrive2() {
		...
		TweenMax.to("#line21", 1, {attr:{x2: "79%", y2: "51.5%" }, onComplete:function() {
			...
			TweenMax.to("#arrowMark11", 1, {attr:{x2: "76%", y2: "51.6%" }, onComplete:function() {
				...
				var text="It will give the result in low level language to the complier.";
	...
	function retrive21() {
		...
		TweenMax.to("#arrowMark14", 1, {attr:{x2: "46.7%", y2: "80.2%" }, onComplete:function() {
			...
			var text="Then the compiler will convert the result to high level language.";
