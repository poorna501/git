...
function introJsFunction() {
	...
	introjs.onafterchange(function(targetElement) {
		...
		case "swapLine":
			$('.introjs-helperLayer').one('transitionend', function () {
				var typingContent = 'In this line we are calling <span class="ct-code-b-yellow">swap</span> method with parameters as ' +
									...
									'<span class="ct-code-b-yellow">x</span>, <span class="ct-code-b-yellow">y</span> respectively.</br>' +
		...
		case "swapMethodBlock":
			var typingContent = 'This is <span class="ct-code-b-yellow">swap()</span> method block with two ' +
